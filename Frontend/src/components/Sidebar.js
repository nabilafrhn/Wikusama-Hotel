...
import { faHome, faBed, faUsers, faUser, faHistory, faList, faHotel, faRightFromBracket } from "@fortawesome/free-solid-svg-icons";
...
export default class Sidebar extends React.Component {
  ...
  render() {
    return (  
      <aside
        class="sidebar w-64 md:shadow transform -translate-x-full md:translate-x-0 transition-transform duration-150 ease-in bg-white shadow"
      >
        ...
        <div class="sidebar-content px-4 py-6">
          {
            this.state.role === "admin" && <ul class="flex flex-col w-full">
              ...
              <li class="my-px">
                <a
                  href="/"
                  class="flex flex-row items-center h-14 px-3 rounded-lg text-sky-800 hover:bg-sky-100 hover:text-gray-700 mt-60"
                >
