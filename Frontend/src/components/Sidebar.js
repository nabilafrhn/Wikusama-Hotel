          ...
          {this.state.role === "admin" && (
            <ul class="flex flex-col w-full">
              <li class="my-px">
                <a
                  href="/dashboard"
                  class="flex flex-row items-center h-14 px-3 rounded-lg text-violet-800 hover:bg-violet-100 hover:text-gray-700"
                >
              ...
              <li class="my-px">
                <a
                  href="/"
                  class="flex flex-row items-center h-14 px-3 rounded-lg text-violet-800 hover:bg-violet-100 hover:text-gray-700 mt-60"
                >
          ...
          {this.state.role === "resepsionis" && (
            <ul class="flex flex-col w-full">
              ...
              <li class="mt-40 mb-0 px-3">
                <a
                  href="/"
                  class="flex flex-row items-center h-14 px-3 rounded-lg text-violet-800 hover:bg-violet-200 hover:text-gray-700 mt-60"
                >
                  <span class="mr-3 flex items-center justify-center text-lg text-red-400">
                    <FontAwesomeIcon icon={faRightFromBracket} />
                  </span>
