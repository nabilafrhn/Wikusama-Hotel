...
export default class Home extends React.Component {
    ...
    showModal = () => {
        ...
        this.setState({
            ...
            booking_date: moment().format('MM/DD/YYYY'),
            check_in_date: "",
            check_out_date: "",
            guest_name: "",
            total_room: "",
                ...
                <section class="bg-sky-800 py-24 mt-6">
                    <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                        <div class="mr-auto place-self-center lg:col-span-7">
                            <h1 class="max-w-2xl mb-8 text-4xl font-extrabold leading-none md:text-4xl xl:text-5xl text-white">Discover The Best Hotels & Resorts to Stay</h1>
                            <p class="max-w-2xl mb-6 font-light lg:mb-14 md:text-lg lg:text-xl text-white">We provide a variety of the best lodging accomodations for those of you who need it. Don't worry about the quality of the service.</p>
                                ...
                                <div className=" bg-white border-2 border-grey rounded-lg shadow h-auto">
                                    <div class="flex flex-row">
                                        ...
                                        <div className="px-4 pt-9 pb-6">
                                            <button className="border border-sky-500 hover:bg-sky-600 text-sky-600 hover:text-white font-semibold p-2 pr-3 pl-3 w-full rounded focus:outline-none focus:shadow-outline" onClick={this.handleFilter}>Check Rooms</button>
                                        </div>
                                    </div>
                                </div>
                                {this.state.isLogin ? (
                                    <div className="px-6 pt-9 pb-6">
                                        <button className=" bg-sky-500 hover:bg-sky-600 hover:text-white text-white font-semibold inline-flex items-center justify-center p-2 px-3 rounded focus:outline-none focus:shadow-outline" onClick={() => this.showModal()}>
                                            Booking now
                                    ...
                                    <div className="px-6 pt-9 pb-6">
                                        <button className=" bg-gray-400 hover:bg-gray-600 hover:text-white text-white font-semibold inline-flex items-center justify-center p-2 px-3 rounded focus:outline-none focus:shadow-outline" disabled>
                                            Booking Now
                                            <svg class="w-5 h-5 ml-2 -mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                                        </button>
                                    </div>
                                    ...
                                    <div class="CardEvent mx-10">
                                        <div class="max-w-sm rounded overflow-hidden shadow-lg ">
                                            <div className='container'>
                                                <img class="w-full h-48" alt="images not found" src={"http://localhost:8080/uploads/image/" + item.photo} />
                                            </div>
                                            <div class="px-6 py-4">
