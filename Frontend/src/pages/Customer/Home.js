...
export default class Home extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <Navbar />
        <section class="bg-violet-800 py-24 mt-6">
          <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
            <div class="mr-auto place-self-center lg:col-span-7">
              ...
              <p class="max-w-2xl mb-6 font-light lg:mb-14 md:text-lg lg:text-2xl text-white">
              ...
              <div class="flex flex-row mb-8">
                <div className=" bg-white border-2 border-grey rounded-lg shadow h-auto">
                  <div class="flex flex-row">
                    ...
                    <div className="px-4 pt-9 pb-6">
                      <button
                        className="border border-violet-500 hover:bg-violet-600 text-violet-600 hover:text-white font-semibold p-2 pr-3 pl-3 w-full rounded focus:outline-none focus:shadow-outline"
                ...
                {this.state.isLogin ? (
                  <div className="px-6 pt-9 pb-6">
                    <button
                      className=" bg-violet-500 hover:bg-violet-600 hover:text-white text-white font-semibold inline-flex items-center justify-center p-2 px-3 rounded focus:outline-none focus:shadow-outline"
        ...
        {this.state.rooms.length > 0 && (
          <section class="bg-gray-100">
            <div class="py-4 lg:py-10 mx-auto max-w-screen-xl px-4">
              <h2 class="lg:mb-8 mt-6 text-3xl font-extrabold tracking-tight leading-tight text-center text-violet-900  md:text-4xl">
                Available Room
              </h2>
            </div>
