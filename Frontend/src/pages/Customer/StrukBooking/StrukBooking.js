      ...
      <div className="mt-4">
        <div className="hotel-invoice">
          ...
          <div className="invoice-details">
            <div>
              <p>
                <span className="font-semibold">Hotel Name:</span> Slippy
              </p>
              <p>
                <span className="font-semibold mt-2">Address:</span> Malang
              </p>
              <p>
                <span className="font-semibold mt-2">Phone:</span> 0331-1234
              </p>
            </div>
            <div>
              <p>
                <span className="font-semibold">Date:</span> 12-03-2023
              </p>
              <p>
