        ...
        <div className="grid grid-cols-1 md:grid-cols-2 m-auto h-[550px] shadow-lg shadow-gray-600 sm:max-w-[900px]">
          ...
          <div className="p-4 flex flex-col justify-around">
            <form onSubmit={(e) => this.handleRegister(e)}>
              <h2 className="text-4xl font-bold text-center mb-8 text-violet-800">
                Wikusama Hotel
              </h2>
              <div>
                <input
              ...
              <button
                type="submit"
                className="w-full py-2 my-4 bg-violet-600 hover:bg-violet-500 text-white font-bold"
              >
                Create an Account
              </button>
            </form>
            <h6 className="text-center">
              ...
              <NavLink to="/login" className="text-violet-800 underline">
                Login
              </NavLink>
            </h6>
          </div>
