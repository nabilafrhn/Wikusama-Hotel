      ...
      <div class="flex flex-row min-h-screen bg-gray-100 text-gray-800">
        ...
        <main class="main flex flex-col flex-grow -ml-64 md:ml-0 transition-all duration-150 ease-in">
          ...
          <div class="main-content flex flex-col flex-grow p-4">
            <h2 class="my-8 text-3xl font-medium">
              Welcome, {this.state.user_name}{" "}
            </h2>
            <div class="flex flex-row h-40">
              <div class="w-1/4 text-gray-700 text-center bg-violet-300 px-4 py-2 m-2 rounded-md border-2  border-violet-400 ">
          ...
          <footer class="footer px-4 py-2">
            <div class="footer-content">
              <p class="text-sm text-gray-600 text-center">© Wikusama Hotel</p>
            </div>
          </footer>
        </main>
      </div>
