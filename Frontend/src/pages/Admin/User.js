                            ...
                            <div className="justify-items-center w-1/2">
                                <div className="rounded ml-5">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="search" id="default-search" class="block p-4 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-sky-500 focus:border-sky-500" placeholder="Search User" name='keyword' value={this.state.keyword} onChange={this.handleChange} />
                                    ...
                                    {this.state.user.map((item, index) => {
                                        return (
                                            <tr class="hover:bg-gray-50" key={index}>
                                                ...
                                                <td class="px-6 py-4">
                                                    <div class="text-sm">
                                                        <div class="font-medium text-gray-700">{item.user_name}</div>
                                                        <div class="text-gray-400">{item.role}</div>
                                                    </div>
                                                </td>
                                                <td class="px-6 py-4">{item.email}</td>
                                                <td class="px-6 py-4">
                                                    <button class="mr-4" onClick={() => this.handleDrop(item.id_user)}>
                                                        <svg
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-white w-1/3">
                            ...
                            <div class="px-6 py-6 lg:px-8">
                                ...
                                <form class="space-y-6" onSubmit={(event) => this.handleSave(event)}>
                                    <div>
                                        <label for="user_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-800">Username</label>
                                        <input type="text" name="user_name" id="user_name" value={this.state.user_name} onChange={this.handleChange} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-sky-500 focus:border-gray-800 block w-full p-2.5 dark:bg-white dark:border-gray-500 dark:placeholder-gray-400 dark:text-gray-800" placeholder="Input your username" required />
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <select name="role" onChange={this.handleChange} id="role" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-sky-500 focus:border-gray-800 block w-full p-2.5 dark:bg-white dark:border-gray-500 dark:placeholder-gray-400 dark:text-gray-800">
                                    ...
                                    <div>
                                        <label for="photo" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-800">Photo</label>
