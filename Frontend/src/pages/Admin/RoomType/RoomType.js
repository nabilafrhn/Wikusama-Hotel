        ...
        <main class="main flex flex-col flex-grow -ml-64 md:ml-0 transition-all duration-150 ease-in">
          ...
          <div class="main-content flex flex-col flex-grow p-4">
            <div class="mb-4 flex flex-row">
              ...
              <button
                className="ml-2 px-4 font-bold text-white bg-violet-600 rounded hover:bg-violet-700"
                    ...
                    <div class="max-w-sm rounded overflow-hidden shadow-lg">
                      ...
                      <div class="px-6 py-4">
                        ...
                        <div class="font-bold text-xl mb-2 text-blue-600">
                          {item.price.toLocaleString("id-ID")}/ Night
                        </div>
                        <p class="text-gray-700 text-base">
                          ...
                          <button
                            ...
                            class="text-violet-800 font-bold"
                          >
                            See All
                          </button>
                        </p>
                ...
                >
                  <div>
                    ...
                    <input
                      ...
                      onChange={this.handleChange}
                      class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-violet-500 focus:border-gray-800 block w-full p-2.5 dark:bg-white dark:border-gray-500 dark:placeholder-gray-400 dark:text-gray-800"
                  ...
                  <button
                    type="submit"
                    class="w-full text-white bg-gradient-to-br from-purple-600 to-violet-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-violet-300 dark:focus:ring-violet-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2"
                  >
                    Simpan
                  </button>
                </form>
